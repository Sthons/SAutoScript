...
class ExampleScript(BaseGameScript):
    ...
    def on_start(self):
        ...
        game_window = self.window_locator.get_window_rect(window_title="游戏窗口")
    ...
    def game_logic(self):
        ...
        self.input_controller.move_mouse(
            self.game_window_center_point["left"], self.game_window_center_point["top"]
        )
        # 鼠标中键点击
