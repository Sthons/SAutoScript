...
class InputController:
    ...
    def __init__(self, config=None):
        ...
        self.overlimit_detection = self.config.get("overlimit_detection", False)  # 是否开启超量识别检测
        ...
        logger.info(f"输入控制器初始化完成，屏幕尺寸: {self.screen_width}x{self.screen_height}")
    ...
    def click(self, x=None, y=None, button="left", clicks=1, interval=0.2, duration=0.2):
        """点击鼠标"""
        try:
            # 如果指定了位置，先移动鼠标
